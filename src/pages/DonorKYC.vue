                ...
                <div class="col-12 col-md-6 col-lg-6">
                  ...
                  >
                    ...
                    >
                      ...
                      <q-icon name="done" color="green" v-else />
                    </q-btn>
                  </q-field>
                </div>
                <div class="col-12 col-md-6 col-lg-6">
                ...
                <div class="col-12 col-md-6 col-lg-6">
                  ...
                  >
                    ...
                    <q-btn
                      ...
                      outline
                    >
                      <q-icon name="photo_camera" v-if="photo_image_done" />
                      <q-icon name="done" color="green" v-else />
                    </q-btn>
                  </q-field>
                </div>
...
const front_image_done = ref(true);
const back_image_done = ref(true);
const photo_image_done = ref(true);
...
const uploadImageFront = () => {
  front_image_done.value = false;
};
const uploadImageBack = () => {
  back_image_done.value = false;
};
const uploadImage = () => {
  console.log('image');
};

const uploadImagePhoto = () => {
  photo_image_done.value = false;
};
const submitKyc = () => {
